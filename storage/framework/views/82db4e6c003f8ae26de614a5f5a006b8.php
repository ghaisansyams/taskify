...
<?php $__env->startSection('subheading', "Here's what's happening with your tasks today."); ?>
...
<div class="space-y-6 animate-fade-in">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-6">
        ...
        <div class="card p-6 hover:-translate-y-1 hover:shadow-lg transition-all duration-300 cursor-default">
            ...
            <p class="text-4xl font-bold text-slate-900"><?php echo e($stats['total']); ?></p>
        ...
        <div class="card p-6 hover:-translate-y-1 hover:shadow-lg transition-all duration-300 cursor-default">
            ...
            <p class="text-4xl font-bold text-slate-700"><?php echo e($stats['todo']); ?></p>
        ...
        <div class="card p-6 hover:-translate-y-1 hover:shadow-lg transition-all duration-300 cursor-default">
            ...
            <p class="text-4xl font-bold text-primary-600"><?php echo e($stats['in_progress']); ?></p>
        ...
        <div class="card p-6 hover:-translate-y-1 hover:shadow-lg transition-all duration-300 cursor-default">
            ...
            <p class="text-4xl font-bold text-green-600"><?php echo e($stats['done']); ?></p>
            <p class="text-xs text-slate-400 mt-2">Completed</p>
        </div>

        
        <div class="card p-6 hover:-translate-y-1 hover:shadow-lg transition-all duration-300 cursor-default <?php echo e($stats['overdue'] > 0 ? 'border-red-100' : ''); ?>">
            <div class="flex items-start justify-between mb-4">
            ...
            <p class="text-4xl font-bold text-red-600"><?php echo e($stats['overdue']); ?></p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="card p-6">
            <div class="flex items-center justify-between mb-5">
                ...
                <span class="text-2xl font-bold text-primary-600"><?php echo e($completionRate); ?>%</span>
            </div>

            <div class="w-full bg-slate-100 rounded-full h-2.5 mb-2">
                <div class="bg-primary-600 h-2.5 rounded-full transition-all duration-700" style="width: <?php echo e($completionRate); ?>%"></div>
            </div>
            <p class="text-xs text-slate-400 mb-6"><?php echo e($stats['done']); ?> of <?php echo e($stats['total']); ?> tasks completed</p>
            ...
            <div class="space-y-3">
                ...
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$key, $dot, $text, $label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-center gap-3">
                    <span class="w-2 h-2 rounded-full <?php echo e($dot); ?> shrink-0"></span>
                    <span class="text-xs text-slate-600 flex-1"><?php echo e($label); ?></span>
                    <span class="text-xs font-bold <?php echo e($text); ?>"><?php echo e($byPriority[$key]->total ?? 0); ?></span>
                </div>
        ...
        <div class="card p-6 lg:col-span-2">
            ...
            <div class="space-y-4">
                ...
                <?php $pct = $cat->total > 0 ? round(($cat->done / $cat->total) * 100) : 0; ?>
                <div>
                    <div class="flex items-center justify-between mb-2">
                        <div class="flex items-center gap-2.5">
                            <div class="w-7 h-7 rounded-lg <?php echo e($catColors[$cat->category] ?? 'bg-slate-100 text-slate-500'); ?> flex items-center justify-center shrink-0">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><?php echo $catIcons[$cat->category] ?? $catIcons['other']; ?></svg>
                            </div>
                            <span class="text-sm font-medium text-slate-700 capitalize"><?php echo e($cat->category); ?></span>
                        </div>
                        <div class="flex items-center gap-3 text-xs">
                            <span class="text-slate-400"><?php echo e($cat->done); ?>/<?php echo e($cat->total); ?></span>
                            <span class="font-bold text-slate-700 w-9 text-right"><?php echo e($pct); ?>%</span>
                        </div>
                    </div>
                    <div class="w-full bg-slate-100 rounded-full h-1.5">
                        <div class="bg-primary-500 h-1.5 rounded-full transition-all duration-700" style="width: <?php echo e($pct); ?>%"></div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="card p-6">
            <div class="flex items-center justify-between mb-5">
                ...
                <a href="<?php echo e(route('tasks.index')); ?>" class="text-xs font-semibold text-primary-600 hover:text-primary-700 transition-colors">View all</a>
            </div>
            <div class="space-y-1">
            ...
            <a href="<?php echo e(route('tasks.show', $task)); ?>" class="flex items-start gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-50 transition-colors group cursor-pointer">
                <span class="mt-1.5 w-2 h-2 rounded-full shrink-0
                    <?php echo e($task->status === 'done' ? 'bg-green-500' : ($task->status === 'in_progress' ? 'bg-blue-500' : 'bg-slate-300')); ?>">
                </span>
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-slate-400 mt-0.5"><?php echo e($task->created_at->diffForHumans()); ?></p>
                </div>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="text-center py-8">
                <p class="text-sm text-slate-400">No tasks yet.</p>
                <a href="<?php echo e(route('tasks.create')); ?>" class="text-sm text-primary-600 font-semibold hover:text-primary-700 mt-1 inline-block">Create one →</a>
            </div>
            <?php endif; ?>
            </div>
        </div>
        ...
        <div class="card p-6">
            <div class="flex items-center justify-between mb-5">
                ...
                <span class="badge bg-red-100 text-red-600"><?php echo e($overdueTasks->count()); ?></span>
                <?php endif; ?>
            </div>
            ...
            <a href="<?php echo e(route('tasks.show', $task)); ?>" class="flex items-start gap-3 px-3 py-2.5 rounded-xl hover:bg-red-50 transition-colors group cursor-pointer">
                <svg class="w-4 h-4 text-red-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-medium text-slate-700 truncate group-hover:text-red-600 transition-colors"><?php echo e($task->title); ?></p>
                    <p class="text-xs text-red-400 mt-0.5"><?php echo e($task->due_date->diffForHumans()); ?></p>
                </div>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="card p-6">
            <div class="flex items-center justify-between mb-5">
                ...
                <?php if($urgentTasks->count() > 0): ?>
                <span class="badge bg-orange-100 text-orange-600"><?php echo e($urgentTasks->count()); ?></span>
                <?php endif; ?>
            </div>
            ...
            <a href="<?php echo e(route('tasks.show', $task)); ?>" class="flex items-start gap-3 px-3 py-2.5 rounded-xl hover:bg-orange-50 transition-colors group cursor-pointer">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-medium text-slate-700 truncate group-hover:text-orange-600 transition-colors"><?php echo e($task->title); ?></p>
                    <p class="text-xs text-slate-400 mt-0.5 capitalize"><?php echo e($task->status_label); ?></p>
                </div>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="flex flex-col items-center justify-center py-8">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/taskify/resources/views/dashboard/index.blade.php ENDPATH**/ ?>